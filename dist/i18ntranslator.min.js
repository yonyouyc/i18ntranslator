(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("xlsx"), require("line-reader"));
	else if(typeof define === 'function' && define.amd)
		define(["xlsx", "line-reader"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("xlsx"), require("line-reader")) : factory(root["xlsx"], root["line-reader"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(global, function(__WEBPACK_EXTERNAL_MODULE__2__, __WEBPACK_EXTERNAL_MODULE__5__) {
...
var _XLSX = __webpack_require__(1)
var readFileContent = __webpack_require__(3).readFileContent
...
var lineReader = __webpack_require__(5)
var getChinese = __webpack_require__(6).getChinese
var destDictionary = __webpack_require__(6).destDictionary
var setting = __webpack_require__(7)
// 读取所有code目录下的文件
